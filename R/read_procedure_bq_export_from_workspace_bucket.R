#' @title Read procedure domain BQ export from workspace bucket
#' @description Read procedure domain BQ export from workspace bucket
#' @param export_path The path to the query result.
#' @return A tibble of procedure data.
#' @export
read_procedure_bq_export_from_workspace_bucket <- function(export_path) {
